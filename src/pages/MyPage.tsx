...
export const MyPage: React.FC<MyPageProps> = ({ result, onOpenLockModal }) => {
  ...
  const menuItems = [
    { label: '내 사주 정보 수정', isLocked: false, value: '수정 가능' },
    { label: '프리미엄 멤버십 상태', isLocked: false, value: '무제한 평생권 활성화' },
    { label: '동양 사주 알림 설정', isLocked: false, value: '활성화' },
    { label: '앱 정보 및 버전', isLocked: false, value: 'v1.0.0 (유료 프리미엄)' },
  ];
