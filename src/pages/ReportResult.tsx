...
export const ReportResult: React.FC<ReportResultProps> = ({ result, onBack, onOpenLockModal }) => {
  ...
  return (
    <div className="scroll-content">
      ...
      {/* Additional Premium Reports List */}
      <div style={{ marginTop: '24px', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' }}>
          {[
            { id: 2, title: '2. 기질 및 성향 분석', desc: '타고난 성격과 기질, 강점과 약점을 자세히 분석해드립니다.', url: '/reports/personality/index.html', char: fireSmall },
            { id: 3, title: '3. 용신(用神)과 희신(喜神) 분석', desc: '나에게 필요한 기운과 보완해야 할 기운을 정확히 짚어드립니다.', url: '/reports/yongshin/index.html', char: metalSmall },
            { id: 4, title: '4. 실생활 맞춤 개운법 (행운의 요소)', desc: '운을 끌어당기는 색상, 숫자, 방향, 물건 등 정운의 요소를 알려드려요.', url: '/reports/lucky-elements/index.html', char: earthSmall },
            { id: 5, title: '5. 공간 개운법 (풍수 및 인테리어)', desc: '집안의 기운을 바꾸는 풍수 인테리어와 공간 개운법을 제안해드립니다.', url: '/reports/fengshui/index.html', char: waterSmall },
            { id: 6, title: '6. 2026년 하반기 총운', desc: '2026년 하반기 전체 운세 흐름과 주요 이슈를 미리 확인해보세요.', url: '/reports/fortune2026/index.html', char: woodSmall }
          ].map((r) => (
            <div 
              key={r.id}
            ...
            >
              ...
              <div style={{ flex: 1, paddingRight: '8px' }}>
                <h4 style={{ fontSize: '13px', fontWeight: 700, color: 'var(--color-text-charcoal)', margin: '0 0 2px 0', fontFamily: 'var(--font-oriental)' }}>
                  {r.title}
                </h4>
              ...
              <div style={{ color: 'var(--color-accent-red)', fontSize: '14px', fontWeight: 'bold', paddingLeft: '4px' }}>&gt;</div>
            </div>
          ))}
        </div>
      </div>

      {/* Dynamic Detailed Report Button */}
